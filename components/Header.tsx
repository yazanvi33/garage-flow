      ...
      <div className="flex items-center space-x-2 rtl:space-x-reverse">
        ...
        <Menu as="div" className="relative inline-block text-left">
          ...
          <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
            <Menu.Items className="origin-top-end absolute end-0 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-secondary-700 ring-1 ring-black dark:ring-secondary-600 ring-opacity-5 focus:outline-none z-20">
              <div className="py-1">
        ...
        {currentUser && (
          <Menu as="div" className="relative inline-block text-left">
            ...
            <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
              <Menu.Items className="origin-top-end absolute end-0 mt-2 w-64 rounded-md shadow-lg py-1 bg-white dark:bg-secondary-700 ring-1 ring-black dark:ring-secondary-600 ring-opacity-5 focus:outline-none z-20">
                  ...
                  {({ open }) => (
                    <>
                      ...
                      <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="opacity-0 translate-y-1" enterTo="opacity-100 translate-y-0" leave="transition ease-in duration-75" leaveFrom="opacity-100 translate-y-0" leaveTo="opacity-0 translate-y-1">
                        <Popover.Panel className="absolute start-full -top-8 z-10 mt-0 ms-1 w-40 transform rounded-md bg-white dark:bg-secondary-700 shadow-lg ring-1 ring-black dark:ring-secondary-600 ring-opacity-5">
                           <div className="py-1">
                ...
                <Popover className="relative">
                  {({ open }) => (
                    <>
                      ...
                      <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="opacity-0 translate-y-1" enterTo="opacity-100 translate-y-0" leave="transition ease-in duration-75" leaveFrom="opacity-100 translate-y-0" leaveTo="opacity-0 translate-y-1">
                        <Popover.Panel className="absolute start-full -top-8 z-10 mt-0 ms-1 w-52 transform rounded-md bg-white dark:bg-secondary-700 shadow-lg ring-1 ring-black dark:ring-secondary-600 ring-opacity-5">
                           <div className="py-1">
