import { User, UserRole, Customer, Vehicle, SparePart, Supplier, Employee, MaintenanceCard, Invoice, InvoiceType, WorkshopStats, Currency, FuelLevel, InventoryMovement, InventoryIssueRequest, InventoryIssueRequestStatus, ReplacedPartCondition, SecondaryWarehouseItem, InventoryIssueRequestItem, ReplacedPartEntry } from './types';
...
export const LABELS: Record<string, Record<string, string>> = {
  ...
  ar: {
    ...
    expenses: "المصروفات",
    externalTechnicians: "فواتير فنيين خارجيين", 
    workshopEquipment: "معدات الورشة",
    ...
    dueFromCustomers: "مستحقات من العملاء (الفترة)",
    dueToSuppliers: "مستحقات للموردين (الفترة)",
    recentActivity: "النشاطات الأخيرة",
    noDataFound: "لا توجد بيانات.",
    loading: "جاري التحميل...",
    selectRole: "اختر الصلاحية",
    pageUnderConstruction: "هذه الصفحة قيد الإنشاء حاليًا.",
    Admin: "مدير",
    Accountant: "محاسب",
    Technician: "فني",
    Outgoing: "صادرة",
    ...
    color: "اللون",
    engineCylinders: "عدد اسطوانات المحرك",
    engineNumber: "رقم المحرك",
    tireSize: "قياس الإطارات",
    columns: "الأعمدة",
    ...
    dateCreated: "تاريخ الإنشاء", // Generic date created
    dateCompleted: "تاريخ الإنجاز",
    dateIssued: "تاريخ الإصدار", // For Invoice context
    reportedIssues: "الأعطال المبلغ عنها",
    faultDescription: "شرح العطل",
    causeOfFailure: "سبب العطل",
    odometerIn: "عداد الكيلومتر (دخول)",
    odometerOut: "عداد الكيلومتر (خروج)",
    ...
    Completed: "مكتملة",
    Cancelled: "ملغي", // Status for Maintenance Card & IIR
    Empty: "فارغ",
    Quarter: "1/4 (ربع)",
    Half: "1/2 (نصف)",
    ...
    select: "اختر",
    description: "الوصف",
    incomingQuantity: "كمية واردة",
    outgoingQuantity: "كمية صادرة",
    partCondition: "حالة القطعة",
    New: "جديدة",
    Used: "مستعملة",
    inventoryIssueRequests: "طلبات إخراج القطع",
    secondaryWarehouse: "المستودع الثانوي",
    reusable: "قابلة لإعادة الاستخدام",
    damaged: "تالفة",
    notPresent: "غير موجودة",
    addNewInventoryIssueRequest: "إضافة طلب إخراج جديد",
    editInventoryIssueRequest: "تعديل طلب إخراج",
    confirmIssueRequest: "تأكيد وإخراج القطع",
    reconcileIssueRequest: "تسوية القطع المستبدلة",
    issueRequest: "طلب إخراج",
    maintenanceCardRequired: "بطاقة الصيانة مطلوبة.",
    selectMaintenanceCard: "اختر بطاقة الصيانة",
    ...
    addReplacedPartInfo: "إضافة معلومات قطعة مستبدلة",
    originalPart: "القطعة الأصلية (من السيارة)",
    conditionOfReplacedPart: "حالة القطعة المستبدلة",
    Draft: "مسودة", // IIR Status
    Issued: "تم الصرف", // IIR Status
    Reconciled: "تمت التسوية", // IIR Status
    iirDateIssued: "تاريخ الصرف", // For IIR context
    dateReconciled: "تاريخ التسوية",
    requestedBy: "مقدم الطلب",
    issuedBy: "أمين المستودع", // Storekeeper
    reconciledBy: "سويت بواسطة",
    selectPart: "اختر قطعة",
    customPartName: "اسم قطعة مخصص",
    items: "البنود",
    part: "القطعة",
    quantity: "الكمية",
    derivedFrom: "مصدرها (طلب إخراج)",
    view: "عرض",
    mainWarehouse: "المستودع الرئيسي",
    secondaryWarehouseReusable: "المستودع الثانوي (صالح للاستخدام)",
    secondaryWarehouseDamaged: "المستودع الثانوي (تالف)",
    linkToMaintenanceCard: "ربط ببطاقة صيانة",
    createIssueRequest: "إنشاء طلب إخراج",
    noIssueRequestLinked: "لا يوجد طلب إخراج مرتبط.",
    searchOrSelectCustomer: "ابحث أو اختر عميل",
    selectCustomerFirst: "اختر العميل أولاً",
    searchOrSelectMaintenanceCard: "ابحث أو اختر بطاقة صيانة",
    selectMaintenanceCardOptional: "اختر بطاقة صيانة (اختياري)",
    vehicleInformation: "معلومات السيارة",
    warehouseSource: "مصدر المستودع",
    requestDate: "تاريخ الطلب",
    receivedBy: "المستلم", // Receiver
    receiverCustomNameLabel: "اسم المستلم (مخصص)",
    searchOrSelectEmployee: "ابحث أو اختر موظف / أدخل اسم مخصص",
    storekeeper: "أمين المستودع", // IssuedBy
    selectEmployee: "اختر موظف",
    selectWarehouse: "اختر المستودع",
    searchOrSelectPart: "ابحث أو اختر قطعة",
    available: "متوفر",
    quantityErrorTooHigh: "الكمية المطلوبة تتجاوز الكمية المتوفرة في المخزون.",
    partDetails: "تفاصيل القطعة",
    cannotEditIssuedReconciled: "لا يمكن تعديل طلب تم صرفه أو تسويته بالفعل.",
    cannotDeleteIssuedReconciled: "لا يمكن حذف طلب تم صرفه أو تسويته بالفعل.",
    canOnlyReconcileIssued: "فقط الطلبات التي تم صرفها يمكن تسويتها.",
    mustAddPartsToRequest: "يجب إضافة قطعة واحدة على الأقل للطلب.",
    replacedQuantityExceedsIssuedFor: "كمية القطع المستبدلة تتجاوز الكمية المصروفة للقطعة",
